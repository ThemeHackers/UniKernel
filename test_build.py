#!/usr/bin/env python3
"""
Comprehensive build system test script with enhanced visual output
"""
...
def test_include_dirs():
    """Test include directories auto-detection"""
...
def test_header_files(inc_dirs):
    """Test CUDA header files detection"""
...
def test_source_files(inc_dirs):
    """Test CUDA source files detection"""
